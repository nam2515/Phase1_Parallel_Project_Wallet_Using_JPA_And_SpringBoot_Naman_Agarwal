...
public class WalletServiceImplTest {
	...
	static WalletRepo wri;
	static WalletServiceImpl wsi;
	@Before
	...
	public void whenTheMobileNumberEnteredAtTheTimeOfCreatingTheAccountAlreadyExist() throws MobileNumberAlreadyExist, MobileNumbeDoesNotExist
	{
	...
	public void whenAtTheTimeOfFundTransferTheSourceWalletDoesNotHaveEnoughAmountToTransfer() throws MobileNumberAlreadyExist, MobileNumbeDoesNotExist, InsufficientBalance
	{
		wsi=new WalletServiceImpl(wri);
		BigDecimal amount=new BigDecimal(500);
